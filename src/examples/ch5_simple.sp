...
#types = #residual_risk + #hazard527 + #risk527 + #hazard537 + #hazard546 + #hazard556 + #risk556 + #hazard565 + #hazard575 + #mod_to_to_display_apprv_aircraft + #modification + #hazard5810 + #hazard5910.
#rule_gterms = {hm_1_6, level_busts, hm_2_9, hm_2_7, to_display_apprv_aircraft, hm_2_1, ht_1_5, ht_1_10, operational_errors, hm_1_10, ht_3_5, hm_2_17, hm_1_1, risk(ht_1_11), asac_usage_risks, risk(hm_1_3), fdps_fps, risk(hm_1_14), hm_1_13, oldi, back_up_systems, mountain_waves, ht_3_6, hm_2_5, ht_1_2, hm_1_15, hm_1_9, ht_1_8, ht_1_1, ht_2_2, hm_2_2, wake_vortices, ht_1_9, ifps, hm_1_8, alert_on_adj_aircraft, hm_2_4, rdps}.
...
crm_valid.
controlled(R) :- mitigated(H), R = risk(H), #risk556(R), #hazard556(H).
...
fc_transition_procedures :- atc_transition_procedures_produced, atc_transition_procedures_validated.
atc_transition_procedures_produced.
atc_transition_procedures_validated.
...
mitigated(hm_2_7).
mitigated(hm_2_9).
atc_equipment_design_complies_with_SRs :- modification_made(alert_on_adj_aircraft), modification_made(to_display_apprv_aircraft), fps_oldi_messaged_display_rfl, hazards_mitigated.
