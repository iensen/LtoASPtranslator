...
#node = 1..6.
#disconnected_1_termS = {1, 4, 5, 2, 6, 3}.
#edge_1_termS = {1, 4, 5, 2, 6, 3}.
#removed_1_termS = {1, 4, 5, 2, 6, 3}.
#reachable_2_termS = {1, 4, 5, 2, 6, 3}.
#reachable_1_termS = {1, 4, 5, 2, 6, 3}.
#reachable_through_2_termS = {1, 4, 5, 2, 6, 3}.
#disconnected_2_termS = {1, 4, 5, 2, 6, 3}.
#edge_2_termS = {1, 4, 5, 2, 6, 3}.
#reachable_through_1_termS = {1, 4, 5, 2, 6, 3}.
#reachable_through_3_termS = {1, 4, 5, 2, 6, 3}.
...
:- 1 < #count{0: disconnected_graph}.
-reachable_through(CWA_Var_1, CWA_Var_2, CWA_Var_3) :- not reachable_through(CWA_Var_1, CWA_Var_2, CWA_Var_3), #reachable_through_1_termS(CWA_Var_1), #reachable_through_2_termS(CWA_Var_2), #reachable_through_3_termS(CWA_Var_3).
...
disconnected_graph. edge. reachable_through. removed. reachable. disconnected. 
