...
#rule_termS = {2, f, dale, below_average, q(1), b, pass, average, e(3), e(2), cher, d, gray, ann, flo, a, inferior, bree, q(2), 1, 3, above_average, fail, c, outstanding, e(1)}.
#prog_termS = #type_termS + #rule_termS.

predicates

student_dropped(#prog_termS). student_rank(#prog_termS, #prog_termS). student_remaining(#prog_termS). higher_rank(#prog_termS, #prog_termS). assessment_score(#prog_termS, #prog_termS, #prog_termS). student_meets_criterion(#prog_termS, #prog_termS). acceptable_assessment(#prog_termS, #prog_termS). 
...
acceptable_assessment(S, A) :- assessment_score(S, A, Some0), #assessment(A), #student(S), #acceptable_grade(Some0).
...
student_meets_criterion(S, outstanding) :- acceptable_assessment(S, e(2)), acceptable_assessment(S, e(3)), acceptable_assessment(S, q(1)), acceptable_assessment(S, e(1)), acceptable_assessment(S, q(2)), assessment_score(S, e(2), a), assessment_score(S, e(1), a), assessment_score(S, e(3), a), #student(S).
student_meets_criterion(S, above_average) :- acceptable_assessment(S, e(2)), acceptable_assessment(S, e(3)), acceptable_assessment(S, q(1)), acceptable_assessment(S, e(1)), acceptable_assessment(S, q(2)), assessment_score(S, E1, a), assessment_score(S, E2, a), E1 != E2, #exam(E1), #exam(E2), #student(S).
student_meets_criterion(S, average) :- acceptable_assessment(S, e(2)), acceptable_assessment(S, e(3)), acceptable_assessment(S, q(1)), acceptable_assessment(S, e(1)), acceptable_assessment(S, q(2)), assessment_score(S, Some0, a), #exam(Some0), #student(S).
student_meets_criterion(S, below_average) :- acceptable_assessment(S, e(2)), acceptable_assessment(S, e(3)), acceptable_assessment(S, q(1)), acceptable_assessment(S, e(1)), acceptable_assessment(S, q(2)), #student(S).
...
:- 1 < #count{0, R: student_rank(S, R), #rank(R)}, student_remaining(S), #student(S).
-assessment_score(CWA0, CWA1, CWA2) :- not assessment_score(CWA0, CWA1, CWA2), #prog_termS(CWA1), #prog_termS(CWA2), #prog_termS(CWA0).
...
student_dropped. student_rank. student_remaining. higher_rank. assessment_score. student_meets_criterion. acceptable_assessment. 
