...
#rule_termS = {a, pass, 1, 3, 2, cher, e(2), f, outstanding, e(1), e(3), b, flo, ann, q(2), d, inferior, average, above_average, q(1), gray, c, below_average, bree, fail, dale}.
#prog_termS = #type_termS + #rule_termS.

predicates

student_rank(#prog_termS, #prog_termS). assessment_score(#prog_termS, #prog_termS, #prog_termS). student_meets_criterion(#prog_termS, #prog_termS). student_remaining(#prog_termS). student_dropped(#prog_termS). acceptable_assessment(#prog_termS, #prog_termS). higher_rank(#prog_termS, #prog_termS). 
...
acceptable_assessment(S, A) :- assessment_score(S, A, Some0), #acceptable_grade(Some0), #student(S), #assessment(A).
...
student_meets_criterion(S, outstanding) :- acceptable_assessment(S, q(1)), acceptable_assessment(S, q(2)), acceptable_assessment(S, e(1)), acceptable_assessment(S, e(3)), acceptable_assessment(S, e(2)), assessment_score(S, e(2), a), assessment_score(S, e(1), a), assessment_score(S, e(3), a), #student(S).
student_meets_criterion(S, above_average) :- acceptable_assessment(S, q(1)), acceptable_assessment(S, q(2)), acceptable_assessment(S, e(1)), acceptable_assessment(S, e(3)), acceptable_assessment(S, e(2)), assessment_score(S, E1, a), assessment_score(S, E2, a), E1 != E2, #exam(E1), #exam(E2), #student(S).
student_meets_criterion(S, average) :- acceptable_assessment(S, q(1)), acceptable_assessment(S, q(2)), acceptable_assessment(S, e(1)), acceptable_assessment(S, e(3)), acceptable_assessment(S, e(2)), assessment_score(S, Some0, a), #exam(Some0), #student(S).
student_meets_criterion(S, below_average) :- acceptable_assessment(S, q(1)), acceptable_assessment(S, q(2)), acceptable_assessment(S, e(1)), acceptable_assessment(S, e(3)), acceptable_assessment(S, e(2)), #student(S).
student_meets_criterion(Every0, inferior) :- #student(Every0).
-student_rank(S, R2) :- -student_meets_criterion(S, R2), #student(S), #rank(R2).
-student_rank(S, R2) :- student_meets_criterion(S, R1), higher_rank(R1, R2), #rank(R1), #student(S), #rank(R2).
...
:- 1 < #count{0, R: student_rank(S, R), #rank(R)}, student_remaining(S), #student(S).
-assessment_score(CWA0, CWA1, CWA2) :- not assessment_score(CWA0, CWA1, CWA2), #prog_termS(CWA2), #prog_termS(CWA0), #prog_termS(CWA1).
...
student_rank. assessment_score. student_meets_criterion. student_remaining. student_dropped. acceptable_assessment. higher_rank. 
