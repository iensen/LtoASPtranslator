...
#higher_rank_1_termS = {below_average, above_average, average, outstanding, inferior}.
#higher_rank_2_termS = {below_average, above_average, average, outstanding, inferior}.
#student_meets_criterion_for_higher_rank_1_termS = {dale, flo, gray, bree, ann, cher}.
#student_rank_1_termS = {dale, flo, gray, bree, ann, cher}.
#student_dropped_1_termS = {bree, dale, ann, cher, flo, gray}.
#student_meets_criterion_2_termS = {below_average, above_average, average, outstanding, inferior}.
#student_meets_criterion_1_termS = {dale, flo, gray, bree, ann, cher}.
#assessment_score_1_termS = {dale, flo, gray, bree, ann, cher}.
#assessment_score_2_termS = {e(2), q(2), 2, 3, q(1), 1, e(1), e(3)}.
#student_remaining_1_termS = {dale, flo, gray, bree, ann, cher}.
#student_meets_criterion_for_higher_rank_2_termS = {below_average, above_average, average, outstanding, inferior}.
#student_meets_criterion_for_higher_rank_3_termS = {below_average, above_average, average, outstanding, inferior}.
#acceptable_assessment_1_termS = {dale, flo, gray, bree, ann, cher}.
#assessment_score_3_termS = {fail, f, a, d, b, pass, c}.
#acceptable_assessment_2_termS = {e(2), q(2), 2, 3, q(1), e(3), e(1), 1}.
#student_rank_2_termS = {below_average, above_average, average, outstanding, inferior}.
...
student_meets_criterion(S, outstanding) :- acceptable_assessment(S, q(2)), acceptable_assessment(S, q(1)), acceptable_assessment(S, e(3)), acceptable_assessment(S, e(2)), acceptable_assessment(S, e(1)), assessment_score(S, e(2), a), assessment_score(S, e(3), a), assessment_score(S, e(1), a), #student(S).
student_meets_criterion(S, above_average) :- acceptable_assessment(S, q(2)), acceptable_assessment(S, q(1)), acceptable_assessment(S, e(3)), acceptable_assessment(S, e(2)), acceptable_assessment(S, e(1)), assessment_score(S, E1, a), assessment_score(S, E2, a), E1 != E2, #exam(E1), #student(S), #exam(E2).
student_meets_criterion(S, average) :- acceptable_assessment(S, q(2)), acceptable_assessment(S, q(1)), acceptable_assessment(S, e(3)), acceptable_assessment(S, e(2)), acceptable_assessment(S, e(1)), assessment_score(S, QuantifiedVar0, a), #student(S), #exam(QuantifiedVar0).
student_meets_criterion(S, below_average) :- acceptable_assessment(S, q(2)), acceptable_assessment(S, q(1)), acceptable_assessment(S, e(3)), acceptable_assessment(S, e(2)), acceptable_assessment(S, e(1)), #student(S).
student_meets_criterion(QuantifiedVar0, inferior) :- #student(QuantifiedVar0).
-student_rank(S, R2) :- student_meets_criterion_for_higher_rank(S, QuantifiedVar0, R2), #student(S), #rank(QuantifiedVar0), #rank(R2).
-student_rank(S, R2) :- -student_meets_criterion(S, R2), #student(S), #rank(R2).
student_meets_criterion_for_higher_rank(S, R1, R2) :- student_meets_criterion(S, R1), higher_rank(R1, R2), #rank(R1), #student(S), #rank(R2).
...
:- 1 < #count{0, R: student_rank(S, R), #rank(R)}, student_remaining(S), #student(S).
-assessment_score(CWA_Var_1, CWA_Var_2, CWA_Var_3) :- not assessment_score(CWA_Var_1, CWA_Var_2, CWA_Var_3), #assessment_score_2_termS(CWA_Var_2), #assessment_score_1_termS(CWA_Var_1), #assessment_score_3_termS(CWA_Var_3).
...
higher_rank. student_meets_criterion. assessment_score. student_remaining. student_meets_criterion_for_higher_rank. student_dropped. acceptable_assessment. student_rank. 
