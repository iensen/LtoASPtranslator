'''
The program 'translator' converts an L program into a semantically equivalent ASP program
...
To run 'translator' via a command-line interface:
    ...
    3.  Call SPARC:
            java -jar solvers/sparc.jar <path_to_ASP_program>
    4.  Make a query about the logic program:
            <query>

An example (Python 3.4.3) with Windows Command Prompt:
    1.  Type:
            cd/d E:\LtoASPtranslator\src
    2.  Type:
            python translator.py examples/ch5.l > tmp/ch5.sp
    3.  Type:
            java -jar solvers/sparc.jar tmp/ch5.sp
    4.  Type:
